...
export const AutoAssignManagementPage = () => {
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            if (editing) {
                await autoAssignRuleService.update(editing.id, payload);
            } else {
                await autoAssignRuleService.create(payload);
            }
            setShowForm(false);
            await fetchAll();
        } catch (err: unknown) {
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            await autoAssignRuleService.delete(id);
            await fetchAll();
    ...
    const handleToggle = async (r: AutoAssignRule) => {
        try {
            await autoAssignRuleService.update(r.id, { isActive: !r.isActive });
            await fetchAll();
