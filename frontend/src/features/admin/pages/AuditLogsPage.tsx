        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="inline-flex items-center rounded-md border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
                    type="button"
                >
                            ...
                            <tr key={log.id} className="hover:bg-slate-50">
                                <td className="whitespace-nowrap px-4 py-3 text-slate-500">
                                    <div className="flex items-center gap-2">
                                        ...
                                        {safeFormat(log.timestamp || log.createdAt, 'MMM d, HH:mm:ss')}
                                    </div>
                                </td>
                                ...
                                <td className="px-4 py-3">
                                    <span className={`inline-flex items-center rounded px-2 py-0.5 text-xs font-medium ${log.actionType === 'DELETE'
                                ...
                                <td className="max-w-md truncate px-4 py-3 text-slate-600" title={log.details}>
                                    {log.details || '-'}
                                </td>
                            </tr>
                        ))}
