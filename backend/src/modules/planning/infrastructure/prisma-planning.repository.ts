...
import { IPlanningRepository } from '../domain/planning.repository';
...
export class PrismaPlanningRepository implements IPlanningRepository {
...
export const planningRepository = new PrismaPlanningRepository();
