...
router.get('/', authenticate, requirePermission('ESCALATION_MANAGE'), async (req: Request, res: Response, next: NextFunction) => {
    try {
...
router.post('/', authenticate, requirePermission('ESCALATION_MANAGE'), async (req: Request, res: Response, next: NextFunction) => {
    try {
...
router.put('/:id', authenticate, requirePermission('ESCALATION_MANAGE'), async (req: Request, res: Response, next: NextFunction) => {
    try {
...
router.delete('/:id', authenticate, requirePermission('ESCALATION_MANAGE'), async (req: Request, res: Response, next: NextFunction) => {
    try {
